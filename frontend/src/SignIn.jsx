  ...
  return (
    <AuthLayout>
      <div class="w-full max-w-md mx-auto rounded-2xl shadow-2xl p-8 bg-white/10 dark:bg-white/10 backdrop-blur-lg border border-white/20">
        <h2 class="text-2xl font-bold mb-6 text-center text-white tracking-tight" style={{fontFamily: 'SF Pro Display, Inter, Arial, sans-serif'}}>Sign In</h2>
        ...
        <p class="mt-6 text-center text-gray-300">
          ...
          <button class="text-blue-300 hover:underline font-semibold" onClick={() => navigate('/signup')}>
            Sign Up
          </button>
        </p>
      </div>
